...
export const ProductImageDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      <ModalHeader data-cy="productImageDeleteDialogHeading" closeButton>
        <Translate contentKey="entity.delete.title">Confirm delete operation</Translate>
      </ModalHeader>
      <ModalBody id="unipassWebApp.productImage.delete.question">
        <Translate contentKey="unipassWebApp.productImage.delete.question" interpolate={{ id: productImageEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-productImage" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
