...
export const ChatMessageDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="unipassWebApp.chatMessage.delete.question">
        <Translate contentKey="unipassWebApp.chatMessage.delete.question" interpolate={{ id: chatMessageEntity.id }}>
