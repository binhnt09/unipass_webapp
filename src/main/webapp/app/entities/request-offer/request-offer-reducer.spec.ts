...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTOFFER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REQUESTOFFER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REQUESTOFFER actions', async () => {
      const arg = { id: 18928 };
    ...
    it('dispatches UPDATE_REQUESTOFFER actions', async () => {
      const arg = { id: 18928 };
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTOFFER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REQUESTOFFER actions', async () => {
      const arg = 42666;
