...
export const PremiumHistory = () => {
  ...
  const totalItems = useAppSelector(state => state.premiumHistory.totalItems);
  ...
  return (
    <div>
                ...
                <tr key={`entity-${premiumHistory.id}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        as={Link as any}
                        to={`/premium-history/${premiumHistory.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        variant="primary"
                        size="sm"
      ...
      {totalItems ? (
        <div className={premiumHistoryList && premiumHistoryList.length > 0 ? '' : 'd-none'}>
