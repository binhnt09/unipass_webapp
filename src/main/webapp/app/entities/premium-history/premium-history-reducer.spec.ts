...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREMIUMHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PREMIUMHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PREMIUMHISTORY actions', async () => {
      const arg = { id: 12120 };
    ...
    it('dispatches UPDATE_PREMIUMHISTORY actions', async () => {
      const arg = { id: 12120 };
    ...
    it('dispatches PARTIAL_UPDATE_PREMIUMHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PREMIUMHISTORY actions', async () => {
      const arg = 42666;
