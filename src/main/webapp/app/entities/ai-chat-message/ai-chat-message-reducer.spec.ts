...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AICHATMESSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AICHATMESSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AICHATMESSAGE actions', async () => {
      const arg = { id: 19947 };
    ...
    it('dispatches UPDATE_AICHATMESSAGE actions', async () => {
      const arg = { id: 19947 };
    ...
    it('dispatches PARTIAL_UPDATE_AICHATMESSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AICHATMESSAGE actions', async () => {
      const arg = 42666;
