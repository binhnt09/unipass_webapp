...
export const ReportDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      <ModalHeader data-cy="reportDeleteDialogHeading" closeButton>
        <Translate contentKey="entity.delete.title">Confirm delete operation</Translate>
      </ModalHeader>
      <ModalBody id="unipassWebApp.report.delete.question">
        <Translate contentKey="unipassWebApp.report.delete.question" interpolate={{ id: reportEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-report" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
