...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELLERREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SELLERREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SELLERREQUEST actions', async () => {
      const arg = { id: 14932 };
    ...
    it('dispatches UPDATE_SELLERREQUEST actions', async () => {
      const arg = { id: 14932 };
    ...
    it('dispatches PARTIAL_UPDATE_SELLERREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SELLERREQUEST actions', async () => {
      const arg = 42666;
