...
import reducer, {
  ...
  reset,
  updateEntity,
} from './system-payment-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMPAYMENTTRANSACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYSTEMPAYMENTTRANSACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYSTEMPAYMENTTRANSACTION actions', async () => {
      const arg = { id: 11084 };
    ...
    it('dispatches UPDATE_SYSTEMPAYMENTTRANSACTION actions', async () => {
      const arg = { id: 11084 };
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMPAYMENTTRANSACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYSTEMPAYMENTTRANSACTION actions', async () => {
      const arg = 42666;
