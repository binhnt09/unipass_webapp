...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRADEREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRADEREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRADEREQUEST actions', async () => {
      const arg = { id: 30297 };
    ...
    it('dispatches UPDATE_TRADEREQUEST actions', async () => {
      const arg = { id: 30297 };
    ...
    it('dispatches PARTIAL_UPDATE_TRADEREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRADEREQUEST actions', async () => {
      const arg = 42666;
