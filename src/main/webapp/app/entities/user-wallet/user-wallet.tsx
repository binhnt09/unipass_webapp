...
export const UserWallet = () => {
  ...
  const totalItems = useAppSelector(state => state.userWallet.totalItems);
  ...
  return (
    <div>
                ...
                <tr key={`entity-${userWallet.id}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        as={Link as any}
                        to={`/user-wallet/${userWallet.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        variant="primary"
                        size="sm"
      ...
      {totalItems ? (
        <div className={userWalletList && userWalletList.length > 0 ? '' : 'd-none'}>
