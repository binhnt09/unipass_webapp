...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENTREACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMENTREACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMENTREACTION actions', async () => {
      const arg = { id: 6183 };
    ...
    it('dispatches UPDATE_COMMENTREACTION actions', async () => {
      const arg = { id: 6183 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMENTREACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMENTREACTION actions', async () => {
      const arg = 42666;
