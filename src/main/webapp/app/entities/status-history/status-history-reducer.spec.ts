...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATUSHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATUSHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STATUSHISTORY actions', async () => {
      const arg = { id: 4499 };
    ...
    it('dispatches UPDATE_STATUSHISTORY actions', async () => {
      const arg = { id: 4499 };
    ...
    it('dispatches PARTIAL_UPDATE_STATUSHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATUSHISTORY actions', async () => {
      const arg = 42666;
