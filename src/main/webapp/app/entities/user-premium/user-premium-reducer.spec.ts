...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPREMIUM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERPREMIUM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERPREMIUM actions', async () => {
      const arg = { id: 9238 };
    ...
    it('dispatches UPDATE_USERPREMIUM actions', async () => {
      const arg = { id: 9238 };
    ...
    it('dispatches PARTIAL_UPDATE_USERPREMIUM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERPREMIUM actions', async () => {
      const arg = 42666;
