...
import reducer, {
  ...
  reset,
  updateEntity,
} from './user-search-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERSEARCHHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERSEARCHHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERSEARCHHISTORY actions', async () => {
      const arg = { id: 20947 };
    ...
    it('dispatches UPDATE_USERSEARCHHISTORY actions', async () => {
      const arg = { id: 20947 };
    ...
    it('dispatches PARTIAL_UPDATE_USERSEARCHHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERSEARCHHISTORY actions', async () => {
      const arg = 42666;
