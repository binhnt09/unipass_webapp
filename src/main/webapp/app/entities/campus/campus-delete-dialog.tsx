...
export const CampusDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="unipassWebApp.campus.delete.question">
        <Translate contentKey="unipassWebApp.campus.delete.question" interpolate={{ id: campusEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-campus" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
