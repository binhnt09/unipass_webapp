...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './campus.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAMPUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CAMPUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CAMPUS actions', async () => {
      const arg = { id: 30951 };
    ...
    it('dispatches UPDATE_CAMPUS actions', async () => {
      const arg = { id: 30951 };
    ...
    it('dispatches PARTIAL_UPDATE_CAMPUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CAMPUS actions', async () => {
      const arg = 42666;
