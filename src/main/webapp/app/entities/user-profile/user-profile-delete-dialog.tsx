...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="unipassWebApp.userProfile.delete.question">
        <Translate contentKey="unipassWebApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
