...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTREACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTREACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTREACTION actions', async () => {
      const arg = { id: 1088 };
    ...
    it('dispatches UPDATE_POSTREACTION actions', async () => {
      const arg = { id: 1088 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTREACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTREACTION actions', async () => {
      const arg = 42666;
