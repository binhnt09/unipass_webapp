...
import reducer, {
  ...
  reset,
  updateEntity,
} from './user-bank-account.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERBANKACCOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERBANKACCOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERBANKACCOUNT actions', async () => {
      const arg = { id: 29731 };
    ...
    it('dispatches UPDATE_USERBANKACCOUNT actions', async () => {
      const arg = { id: 29731 };
    ...
    it('dispatches PARTIAL_UPDATE_USERBANKACCOUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERBANKACCOUNT actions', async () => {
      const arg = 42666;
