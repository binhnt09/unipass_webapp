...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTCATEGORY actions', async () => {
      const arg = { id: 24232 };
    ...
    it('dispatches UPDATE_POSTCATEGORY actions', async () => {
      const arg = { id: 24232 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTCATEGORY actions', async () => {
      const arg = 42666;
