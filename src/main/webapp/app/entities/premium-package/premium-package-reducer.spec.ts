...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREMIUMPACKAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PREMIUMPACKAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PREMIUMPACKAGE actions', async () => {
      const arg = { id: 13982 };
    ...
    it('dispatches UPDATE_PREMIUMPACKAGE actions', async () => {
      const arg = { id: 13982 };
    ...
    it('dispatches PARTIAL_UPDATE_PREMIUMPACKAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PREMIUMPACKAGE actions', async () => {
      const arg = 42666;
