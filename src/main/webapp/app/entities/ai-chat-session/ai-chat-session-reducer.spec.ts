...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AICHATSESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AICHATSESSION actions', async () => {
      const arg = { id: 28921 };
    ...
    it('dispatches UPDATE_AICHATSESSION actions', async () => {
      const arg = { id: 28921 };
    ...
    it('dispatches PARTIAL_UPDATE_AICHATSESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AICHATSESSION actions', async () => {
      const arg = 42666;
