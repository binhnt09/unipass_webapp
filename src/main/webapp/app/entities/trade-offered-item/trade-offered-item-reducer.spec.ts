...
import reducer, {
  ...
  reset,
  updateEntity,
} from './trade-offered-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRADEOFFEREDITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRADEOFFEREDITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRADEOFFEREDITEM actions', async () => {
      const arg = { id: 26041 };
    ...
    it('dispatches UPDATE_TRADEOFFEREDITEM actions', async () => {
      const arg = { id: 26041 };
    ...
    it('dispatches PARTIAL_UPDATE_TRADEOFFEREDITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRADEOFFEREDITEM actions', async () => {
      const arg = 42666;
