...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ITEMREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ITEMREQUEST actions', async () => {
      const arg = { id: 8898 };
    ...
    it('dispatches UPDATE_ITEMREQUEST actions', async () => {
      const arg = { id: 8898 };
    ...
    it('dispatches PARTIAL_UPDATE_ITEMREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ITEMREQUEST actions', async () => {
      const arg = 42666;
