...
import { Check, Crown, Star, TrendingUp, Zap, Shield, Sparkles } from 'lucide-react';
  ...
  <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
        ...
        {/* Card 2: Gói Tiêu chuẩn (49.000đ) - Elevated/Featured */}
        <div className="bg-white rounded-2xl shadow-xl border-4 border-[#FF6B35] p-8 transition-all hover:shadow-2xl transform md:scale-105 relative flex flex-col">
          ...
          <div className="mb-8">
            <div className="flex items-baseline gap-2">
              <span className="text-5xl font-bold text-[#0A2647]">49.000đ</span>
            </div>
      ...
      <div className="max-w-3xl mx-auto mt-12">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 divide-y divide-gray-200">
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600">Có! Bạn có thể hủy gói đăng ký bất cứ lúc nào. Không có ràng buộc hợp đồng hay phí hủy.</p>
          </div>
          <div className="p-6">
            <h4 className="font-medium text-gray-900 mb-2">Điều gì xảy ra khi tôi nâng cấp?</h4>
            <p className="text-sm text-gray-600">
              Tất cả tính năng Premium được kích hoạt ngay lập tức sau khi thanh toán thành công. Sản phẩm của bạn sẽ được hiển thị tốt hơn
              trong vòng vài phút.
            </p>
          </div>
          <div className="p-6">
